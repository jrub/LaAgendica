...
.controller('MapCtrl', function($scope, $ionicLoading, $compile, $localstorage, $state, $rootScope) {
  ...
  .controller('TeamCtrl', function($scope, InAppBrowserService) {
    ...
    var javi = {
      ...
      imagenPerfil: 'https://www.gravatar.com/avatar/1328823cb98b75b1f020eabed78b1ff9.png?s=40'
    }
    var tor  = {
      ...
      imagenPerfil: 'https://www.gravatar.com/avatar/1b951ff3d08e1d7fb7b7f94242855531.png?s=40'
    }
